...
@immutable
class OrderFood extends Equatable {
  ...
  factory OrderFood.fromMap(Map<String, dynamic> map) {
    return OrderFood(
      orderId: map['orderId'] ?? '',
      uid: map['uid'] ?? '',
  ...
  factory OrderFood.fromJson(String source) => OrderFood.fromMap(json.decode(source));
